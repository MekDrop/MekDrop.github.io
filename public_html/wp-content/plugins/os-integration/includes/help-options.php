<?php
	...
	$help_screen->add_help_tab(
		...
		array(
			'title'    => 	__('Advanced'),
			'id'       => 	'advanced_tab',
			'content'  => 	'<p>' . __('<b>Force rebuild</b>: By default, images and other icons are only regenerated when new images are selected, if you have changed the background color or other options and want to regenerate the images, select this option and save the settings.') . '</p>' .
