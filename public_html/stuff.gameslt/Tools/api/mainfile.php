...
if (!defined("XOOPS_MAINFILE_INCLUDED")) {
	...
	// Example: define( 'XOOPS_ROOT_PATH', '/home/mekdrop/webs/stuff.gameslt.mekdrop.name/public_html/Tools/api' );
	...
	// Example: define( 'XOOPS_TRUST_PATH', '/home/mekdrop/webs/stuff.gameslt.mekdrop.name/public_html/Tools/api/config-4939ae76723928' );
	define( 'XOOPS_TRUST_PATH', __DIR__ . '/config-4939ae76723928' );

	include_once XOOPS_TRUST_PATH . '/b67ee495b9db5c73753b334f36cf8ab0.php' ;

	// XOOPS Virtual Path (URL)
	// Virtual path to your main XOOPS directory WITHOUT trailing slash
	// Example: define( 'XOOPS_URL', 'http://stuff.gameslt.mekdrop.name/Tools/api' );
	define( 'XOOPS_URL', 'http://stuff.gameslt.mekdrop.name/Tools/api' );
