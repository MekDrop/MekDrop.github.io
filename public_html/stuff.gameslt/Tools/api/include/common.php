...
if (!empty($_POST['xoops_theme_select']) && in_array($_POST['xoops_theme_select'], $icmsConfig['theme_set_allowed'])) {
	$_SESSION->theme = $icmsConfig['theme_set'] = $_POST['xoops_theme_select'];
} elseif (!empty($_POST['theme_select']) && in_array($_POST['theme_select'], $icmsConfig['theme_set_allowed'])) {
	$_SESSION->theme = $icmsConfig['theme_set'] = $_POST['theme_select'];
} elseif (!empty($_SESSION->theme) && in_array($_SESSION->theme, $icmsConfig['theme_set_allowed'])) {
	$icmsConfig['theme_set'] = $_SESSION->theme;
}
