...
define( 'SDATA_DB_USER', 'mekdrop_gameslt' );

// Database Password
// Password for your database user account
define( 'SDATA_DB_PASS', 'hRO3hVIg' );

// Database Name
// The name of database on the host. The installer will attempt to create the database if not exist
define( 'SDATA_DB_NAME', 'mekdrop_gameslt' );
...
define( 'SDATA_DB_PREFIX', '4093103402' );
...
define( 'SDATA_DB_SALT', 'rPWFZXnmwpis3lgdzEi6S71zW6D0ww5O0K05zcMDTc3H0h2WOdKw0cCQV1w0AH0qj' );
?>