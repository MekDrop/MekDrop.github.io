/*
 * loads HTML into divs with data-dynamic-uri attributes using ajax
 *
 *  -can authenticate against cookie when data-auth-uri attribue is present
 */
define(['./underscore', './require-utils/cookie', './require-utils/module-activator'], function (_, cookie, activator) {
    var exports = {},
